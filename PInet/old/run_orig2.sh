...
python utils/train_richdbd2_fixed6mmgk.py --dataset ../data/exon --fold 2 --dataset_name _CONTACT --cuda 1
python utils/train_richdbd2_fixed6mmgk.py --dataset ../data/exon --fold 3 --dataset_name _CONTACT --cuda 1
python utils/train_richdbd2_fixed6mmgk.py --dataset ../data/exon --fold 4 --dataset_name _CONTACT --cuda 1
