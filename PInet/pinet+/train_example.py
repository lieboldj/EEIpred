...
mepoch=100
op='adam'
tf='/home/liebold/PInet/data/dbd'
labelminus=0
indim=14
stepsize=20
gamma=0.3
...
save_path='/home/liebold/'+log_name
sycn=False
...
#                     self.mha_c.append(MHA_cross_pos2(emb[i],head,ffn[i],ln,df,nopos=nopo))
        ...
        if finetune==1:
            cp=torch.load('pn-val-epoch=09-val_total=0.983.ckpt')            
...
#         dl=dl[:,0:indim,:]
        ...
        if labelminus:
            ...
            sy=torch.cat((lr,ll),dim=1).view(-1,1)
    ...
    def train_dataloader(self):
        if msf=='masif':
            ...
            train=proteindataset.ProteinDatasetSam('/home/liebold/PInet/data/dbd/train_test_split/tts0/shuffled_train_file_list_l.json',
                                                 subsample=presubsam,normsize=normsize,mul=multi,
                                                   folder=tf,nop=nop,dcut=dcut,powerd=pd,hf=half)
    ...
    def val_dataloader(self):
        if msf=='masif':
            ...
            test=proteindataset.ProteinDatasetSam('/home/liebold/PInet/data/dbd/train_test_split/tts0/shuffled_test_file_list_l.json',
