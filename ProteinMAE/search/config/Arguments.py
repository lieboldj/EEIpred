...
# Main parameters
parser.add_argument(
    "--experiment_name", type=str, default='Transformer_search_batch32_given_pretrained', help="Name of experiment"
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=str,
    default="Transformer",
    choices=["dMaSIF", "DGCNN", "PointNet++", "Transformer"],
...
parser.add_argument(
    "--radius", type=float, default=15.0, help="Radius to use for the convolution"
)
parser.add_argument(
    "--k",
    type=int,
...
parser.add_argument(
    "--batch_size", type=int, default=16, help="Number of proteins in a batch"
)
parser.add_argument(
...
parser.add_argument(
    "--ckpt", type=str, default=None, help="ckpt path"#'./checkpoint/ckpt-last.pth'
)


parser.add_argument(
    "--balance_sampling", type=bool, default=False, help="solve data imbalance"
)

parser.add_argument(
    "--checkpoint", type=str, default='./checkpoint/Transformer_search_batch32_group512_size16_downsample512_6.15_epoch493.pth', help="weight for test"
)
...
parser.add_argument(
    ...
    type=int,
    default=1,
    help="ID of fold to run for cross validation",
)

parser.add_argument(
    "--pdb_dir",
    type=str,
    default="../../dmasif/surface_data/raw/01-benchmark_pdbs/",
    help="directory where we find our pdb files",
)

parser.add_argument(
    "--exon_dir",
    type=str,
    default="../../data_collection/uniprot_EnsemblExonPDB_map/",
    help="directory where we find our pdb files",
)
...
parser.add_argument(
    ...
    type=bool,
    default=True,
    help="Save the exon pair predictions? (True/False)",
)

parser.add_argument(
    "--data_root",
    type=str,
    default="../../data_collection/cv_splits/",
    help="Location of the cross validation splits",
)
# Transformer_search_batch32_pre_group512_size16_downsample512_6.15_epoch493.pth
# Transformer_search_batch32_nopre_group512_size16_downsample512_6.16_epoch382.pth
