...
def generate_matchinglabels(args, P1, P2):
    ...
    xyz_dists = (1.0 - xyz_dists).step() # here change the distance
...
def compute_loss(args, P1, P2, n_points_sample=16):
    ...
    if args.search:
        ...
        pos_preds = pos_desc_dists[pos_xyz_dists < 1.0] # here change the distance
        ...
        pos_preds2 = pos_desc_dists2[pos_xyz_dists.T < 1.0]  # here change the distance
    ...
    for it, protein_pair in enumerate(
        ...
        for protein_it in range(protein_batch_size):
            ...
            try:
                ...
                wrong_ids.append(batch_ids[protein_it])
                continue
