...
#CKPT_PATH=$GLINT_ROOT/ckpts/model_0.pt
...
#python scripts/compute_dist.py $srcdir/$receptor/$receptor.pdb $srcdir/$ligand/$ligand.pdb $srcdir/labels.pkl
echo "done with $receptor $srcdir"
#echo "predict $pkl"
...
#python glinter/models/msa_model_train.py --dimer-root x --feature heavy-atom-graph,surface-graph,coordinate-ca-graph,pickled-esm