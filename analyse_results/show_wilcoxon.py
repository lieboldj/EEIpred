...
plt.savefig(f"../results/plots/wilcoxon/{metric}_wil_all.png", bbox_extra_artists=(y_lab,), bbox_inches='tight', dpi=600)

#write data to file
data.to_csv(f"../results/plots/wilcoxon/{metric}_wil_all.csv")